...
public class NhapDiem extends javax.swing.JPanel {
    ...
    private void jFileChooser1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jFileChooser1ActionPerformed
        ...
        if ( exten.equals("CSV") ) {
            ...
            try {
                List diemList = readcsv.ReadDiem(file);
                DiemDAO diemDAO= new DiemDAO();
                for (int i=0;i<diemList.size();i++)
                {
                    diemDAO.addDiem((Diem) diemList.get(i));
                }
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        // TODO add your handling code here:
            ...
            iddiem.setMaLop(jTextField1.getText());
            iddiem.setMaMh(jTextField2.getText());
            iddiem.setMssv(jTextField3.getText());
            iddiem.setNamHoc(2020);
            diem.setId(iddiem);
            diem.setDiemGk(Float.valueOf(jTextField4.getText()));
            diem.setDiemKhac(Float.valueOf(jTextField5.getText()));
            diem.setDiemCk(Float.valueOf(jTextField6.getText()));
            diem.setDiemTk(Float.valueOf(jTextField7.getText()));
            DiemDAO diemDAO = new DiemDAO();
            diemDAO.updateDiem(diem);
            lb_Message.setText("Sửa điểm sinh viên mã " + jTextField3.getText() + " thành công!");
